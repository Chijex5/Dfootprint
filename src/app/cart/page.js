...
const CartPage = () => {
  ...
  return (
    <div className="p-4 sm:p-8 bg-background dark:bg-darkBackground min-h-screen">
      <header className={`fixed top-0 left-0 w-full z-50 bg-white dark:bg-darkSecondary dark:text-white shadow-lg transition-all duration-500 ease-in-out transform bg-opacity-90`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <nav className="flex space-x-4 items-center">
            ...
            <Link href="/products" className="text-gray-700 hover:text-primary dark:text-white transition-colors transform hover:scale-105 duration-200">Products</Link>
            <DarkModeToggle 
              visible={true}
            />
          </nav>
      ...
      <div className="max-w-5xl mx-auto flex flex-col mt-[80px] space-y-8">
        {/* Title */}
