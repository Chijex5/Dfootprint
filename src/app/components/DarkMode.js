...
const DarkModeToggle = ({visible}) => {
  const [darkMode, setDarkMode] = useState(false);

  useEffect(() => {
    // Retrieve the last mode from localStorage on initial load
      ...
      >
        {darkMode ? (
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="h-7 md:h-10 text-primary dark:text-white"
          >
          ...
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="h-7 md:h-10 text-primary dark:text-darkPrimary"
          >
