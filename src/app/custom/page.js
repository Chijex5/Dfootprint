    ...
    <div className="min-h-screen bg-background dark:bg-darkBackground text-secondary dark:text-darkAccent p-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <nav className="flex space-x-4 items-center">
            ...
            <Link href="/products" className="text-gray-700 hover:text-primary dark:text-white transition-colors transform hover:scale-105 duration-200">Change Section</Link>
            <DarkModeToggle 
              visible={true}
            />
          </nav>
